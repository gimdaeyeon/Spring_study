...
//    이 어노테이션은 외부파이의 설정 값들을 자바 객체로 가져올 때 사용한다.
...
//    가져온 값을 new HikariConfig();로 만든 객체의 필드에 바인딩한다.
    ...
    @Bean // 메소드의 반환객체를 Bean으로 등록하는 어노테이션
